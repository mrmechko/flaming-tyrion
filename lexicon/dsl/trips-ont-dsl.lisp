...
(CONCEPT ONT::BEGINNING
         (INHERIT ONT::BOUND)
         (OVERLAP WN::|beginning%1:28:00::|))
...
(CONCEPT ONT::COLOR-LEVEL (INHERIT ONT::LEVEL))
...
(CONCEPT ONT::EXTENT-PREDICATE
         ...
         (SEM-FRAME
          (ONT::GROUND (SEM-FEATS (INHERIT ABSTR-OBJ) (SCALE LENGTH-SCALE)))
          (ONT::FIGURE (CONCEPT SITUATION))))
...
(CONCEPT ONT::FROM-LOC
         ...
         (SEM-FRAME
          (ONT::GROUND
           (SEM-FEATS (INHERIT PHYS-OBJ) (SPATIAL-ABSTRACTION SPATIAL-POINT)))
          (ONT::FIGURE (SEM-FEATS (INHERIT SITUATION) (TYPE EVENT-OF-CHANGE)))))
...
(CONCEPT ONT::HEIGHT-LEVEL (INHERIT ONT::LEVEL))
