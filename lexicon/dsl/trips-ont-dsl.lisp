...
(CONCEPT ONT::ACT
         ...
         (OVERLAP WN::|atone%2:37:00|
                  WN::|break_even%2:40:00|
                  WN::|campaign%2:33:00|
                  WN::|err%2:31:00|
                  WN::|excel%2:42:00|
                  WN::|exercise%2:29:00|
                  ...
                  WN::|hide%2:39:01|
                  WN::|indulge%2:41:01|
                  WN::|keep_one's_mouth_shut%2:32:00|
                  WN::|keep_to_oneself%2:41:00|
                  WN::|keep_up%2:33:00|)
...
(CONCEPT ONT::AGENT-INTERACTION
         (INHERIT ONT::EVENT-OF-AGENT-INTERACTION)
         (SEM-FRAME
          (ONT::AGENT
           (SEM-FEATS (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ))
                      (INTENTIONAL +)))))
...
(CONCEPT ONT::AGREEMENT
         (INHERIT ONT::AGENT-INTERACTION)
         (SEM-FRAME (ONT::ASSOCIATED-INFORMATION (CONCEPT T) OPTIONAL)
...
(CONCEPT ONT::ANIMAL-PROPERTY-VAL
         ...
         (SEM-FRAME
          (ONT::CONTENT (OR (CONCEPT ABSTR-OBJ) (CONCEPT SITUATION)) OPTIONAL)
          (ONT::NEUTRAL
...
(CONCEPT ONT::ARRIVING
         (INHERIT ONT::PHYSICAL-MOTION)
         (SEM-FRAME (ONT::TO-LOC (CONCEPT T))))
...
(CONCEPT ONT::ASSERT (INHERIT ONT::ANNOUNCE) (OVERLAP WN::|insist%2:32:00|))
...
(CONCEPT ONT::AUX
         ...
         (SEM-FRAME (ONT::SITUATION (CONCEPT SITUATION))
                    (ONT::FORMAL (CONCEPT T))))

(CONCEPT ONT::AVAILABILITY-VAL
         (INHERIT ONT::CAN-BE-DONE-VAL)
         (SEM-FRAME (ONT::PROPERTY (CONCEPT ABSTR-OBJ) OPTIONAL)
                    (ONT::VAL (OR (CONCEPT PHYS-OBJ) (CONCEPT SITUATION))
                     OPTIONAL)))
...
(CONCEPT ONT::AWARENESS-VAL (INHERIT ONT::BODY-PROPERTY-VAL))
...
(CONCEPT ONT::BE-AT
         ...
         (SEM-FEATS (INHERIT SITUATION)
                    ...
                    (TIME-SPAN EXTENDED)
                    (ASPECT STATIC))
         (SEM-FRAME (ONT::SPATIAL-LOC (CONCEPT T)) (ONT::NEUTRAL (CONCEPT T))))
...
(CONCEPT ONT::BECOMING-AWARE
         ...
         (SEM-FRAME ((ONT::AGENT ONT::COGNIZER) (CONCEPT T))
                    (ONT::STATIVE (CONCEPT T) OPTIONAL)
                    (ONT::SOURCE (CONCEPT T) OPTIONAL)))
...
(CONCEPT ONT::BET
         ...
         (SEM-FRAME (ONT::FORMAL (CONCEPT T) OPTIONAL)
                    (ONT::COST (SEM-FEATS (INHERIT PHYS-OBJ) (ORIGIN HUMAN)))))
...
(CONCEPT ONT::BIKE (INHERIT ONT::DRIVE))

(CONCEPT ONT::BIND-INTERACT
         (INHERIT ONT::ATTACH)
         (SEM-FEATS (INHERIT SITUATION) (CAUSE AGENTIVE) (ASPECT DYNAMIC))
         (SEM-FRAME
          (ONT::AFFECTED1 (SEM-FEATS (INHERIT PHYS-OBJ) (TYPE MOLECULAR-PART)))
...
(CONCEPT ONT::BODILY-PROCESS
         ...
         (SEM-FRAME (ONT::PROPERTY (CONCEPT ABSTR-OBJ) OPTIONAL)
                    (ONT::AFFECTED
                     (SEM-FEATS (INHERIT PHYS-OBJ) (FORM SUBSTANCE)) OPTIONAL)
                    (ONT::AGENT
...
(CONCEPT ONT::BODY-MOVEMENT
         ...
         (SEM-FEATS (INHERIT SITUATION) (TRAJECTORY +))
         (SEM-FRAME (ONT::PATH (CONCEPT T) OPTIONAL)
                    (ONT::ADDRESSEE (CONCEPT T) OPTIONAL)
                    (ONT::AGENT
                     (OR (CONCEPT SITUATION)
                         (CONCEPT PHYS-OBJ)
                         (CONCEPT ABSTR-OBJ)))
...
(CONCEPT ONT::BREAK-OBJECT
         ...
         (OVERLAP WN::|wreck%1:11:00|
                  ...
                  WN::|fracture%2:29:01|
                  WN::|break%2:35:13|)
         (SEM-FRAME (ONT::INSTRUMENT (CONCEPT PHYS-OBJ) OPTIONAL)
...
(CONCEPT ONT::CHANGE-FORMAT (INHERIT ONT::ADJUST))
...
(CONCEPT ONT::CHANGE-STATE-ACTION
         ...
         (SEM-FRAME
          (ONT::INSTRUMENT (SEM-FEATS (INHERIT PHYS-OBJ) (INTENTIONAL -))
           OPTIONAL)
...
(CONCEPT ONT::COGITATION
         ...
         (OVERLAP WN::|look_at%2:31:00|
                  ...
                  WN::|consider%2:32:00|)
         (SEM-FEATS (INHERIT SITUATION) (TRAJECTORY -))
         (SEM-FRAME (ONT::PREDICATE (CONCEPT T) OPTIONAL)
                    (ONT::FORMAL
                     (OR (CONCEPT PHYS-OBJ)
                         (CONCEPT ABSTR-OBJ)
                         (CONCEPT SITUATION)))
...
(CONCEPT ONT::CUT
         ...
         (SEM-FRAME
          (ONT::INSTRUMENT
           (SEM-FEATS (INHERIT PHYS-OBJ) (FORM SOLID-OBJECT) (INTENTIONAL -))
           OPTIONAL)
          (ONT::AGENT (CONCEPT T))
          (ONT::FORMAL (CONCEPT T))))
...
(CONCEPT ONT::DAMAGE
         ...
         (SEM-FRAME
          (ONT::INSTRUMENT
           (SEM-FEATS (INHERIT PHYS-OBJ) (FORM SOLID-OBJECT) (INTENTIONAL -))
           OPTIONAL)
          (ONT::RESULT (CONCEPT ABSTR-OBJ) OPTIONAL)
          (ONT::AFFECTED (CONCEPT T))
          (ONT::AGENT
           (SEM-FEATS (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ))
                      (INTENTIONAL +)))))
...
(CONCEPT ONT::DIRECT-INFORMATION
         ...
         (INHERIT ONT::COMMUNICATION SITUATION)
         (SEM-FRAME (ONT::INSTRUMENT (CONCEPT T))
                    (ONT::FORMAL
                     (SEM-FEATS (INHERIT ?S)
                                (INFORMATION INFORMATION-CONTENT)))))

(CONCEPT ONT::DIRECT-REPRESENTATION
         (INHERIT ONT::INFO-HOLDER)
         (SEM-FRAME (ONT::ASSOCIATED-INFORMATION (CONCEPT T) OPTIONAL)))
...
(CONCEPT ONT::DISCUSS (INHERIT ONT::TALK) (OVERLAP WN::|discuss%2:32:00|))
...
(CONCEPT ONT::EMPTYING (INHERIT ONT::PHYSICAL-MOTION))
...
(CONCEPT ONT::ENCODING
         ...
         (OVERLAP WN::|spell%2:32:00|
                  ...
                  WN::|spell%2:36:00|)
         (SEM-FRAME (ONT::PURPOSE (CONCEPT T) OPTIONAL)
                    (ONT::MANNER (CONCEPT T) OPTIONAL)))
...
(CONCEPT ONT::EVENT
         ...
         (SEM-FEATS (INHERIT SITUATION) (ASPECT DYNAMIC))
         (SEM-FRAME (ONT::CONTENT (CONCEPT T) OPTIONAL)
                    (ONT::OF (CONCEPT T) OPTIONAL)))
...
(CONCEPT ONT::EVENT-OF-AGENT-INTERACTION
...
(CONCEPT ONT::EXPENSIVENESS
         ...
         (SEM-FRAME
          (ONT::FORMAL
           (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ) (CONCEPT SITUATION)))
          (ONT::COST (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)))))
...
(CONCEPT ONT::EXPERIENCER-EMOTION
         ...
         (SEM-FRAME (ONT::ACTION (CONCEPT T) OPTIONAL)
                    (ONT::FORMAL (CONCEPT T) OPTIONAL)
                    (ONT::NEUTRAL1 (CONCEPT T) OPTIONAL)
...
(CONCEPT ONT::EXPRESS
         (INHERIT ONT::COMMUNICATION)
         (OVERLAP WN::|state%2:32:02|
                  WN::|express%2:32:03|
                  WN::|give_tongue_to%2:32:00|
                  WN::|utter%2:32:01|
                  WN::|verbalise%2:32:03|
                  WN::|verbalize%2:32:03|
                  WN::|express%2:32:00|
                  WN::|frame%2:32:00|
                  WN::|redact%2:32:00|
                  WN::|cast%2:32:00|
...
(CONCEPT ONT::GIVING
         ...
         (SEM-FRAME (ONT::RESULT (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)))
                    (ONT::AFFECTED-RESULT
                     (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)))
                    (ONT::AFFECTED
                     (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)))))
...
(CONCEPT ONT::GUM-PROMISE (INHERIT ONT::PROMISE))
...
(CONCEPT ONT::HAVE-PROPERTY
         ...
         (SEM-FEATS (INHERIT SITUATION)
                    ...
                    (TIME-SPAN EXTENDED)
                    (ASPECT STATIC))
         (SEM-FRAME (ONT::PROPERTY (CONCEPT ABSTR-OBJ))
                    (ONT::FORMAL
                     (OR (CONCEPT PHYS-OBJ)
                         (CONCEPT ABSTR-OBJ)
                         (CONCEPT SITUATION))
...
(CONCEPT ONT::INSURE (INHERIT ONT::PROMISE))
...
(CONCEPT ONT::INTENTIONALLY-ACT
         ...
         (SEM-FRAME
          (ONT::AGENT
           (SEM-FEATS (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ))
                      (INTENTIONAL +)))
          (ONT::ACTION (SEM-FEATS (INHERIT SITUATION) (CAUSE AGENTIVE)))))
...
(CONCEPT ONT::INTERSECT
         ...
         (OVERLAP WN::|cross%2:38:03|
                  ...
                  WN::|coexist%2:42:00|)
         (SEM-FEATS (INHERIT SITUATION) (CAUSE -) (ASPECT INDIV-LEVEL))
         (SEM-FRAME (ONT::SPATIAL-LOC (CONCEPT PHYS-OBJ))
                    (ONT::NEUTRAL1
                     (SEM-FEATS (INHERIT PHYS-OBJ)
                                (SPATIAL-ABSTRACTION
...
(CONCEPT ONT::JOINING
         ...
         (SEM-FEATS (INHERIT SITUATION) (TRAJECTORY -))
         (SEM-FRAME
          (ONT::SPATIAL-LOC (SEM-FEATS (INHERIT PHYS-OBJ) (INTENTIONAL -))
           OPTIONAL)
          (ONT::INSTRUMENT (SEM-FEATS (INHERIT PHYS-OBJ) (INTENTIONAL -))
           OPTIONAL)
...
(CONCEPT ONT::LEARN
         ...
         (SEM-FRAME
          ...
          (ONT::ASSOCIATED-INFORMATION (CONCEPT T) OPTIONAL)
          (ONT::FORMAL (OR (CONCEPT SITUATION) (CONCEPT ABSTR-OBJ)))
          (ONT::AFFECTED (SEM-FEATS (INHERIT PHYS-OBJ) (INTENTIONAL +))
           OPTIONAL)
          (ONT::AGENT (SEM-FEATS (INHERIT PHYS-OBJ) (INTENTIONAL +)) OPTIONAL)))
...
(CONCEPT ONT::MOLECULAR-SITE
         (INHERIT ONT::MOLECULAR-PART)
         (OVERLAP WN::|site%1:15:02|
                  WN::|position%1:10:01|
                  WN::|position%1:15:00|
                  WN::|location%1:03:00|))
...
(CONCEPT ONT::NOMINATE-REFER (INHERIT ONT::SUGGEST))
...
(CONCEPT ONT::NOT-FAMILIAR
         (INHERIT ONT::SALIENCE)
         (SEM-FRAME
          (ONT::PREDICATE
           (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ) (CONCEPT SITUATION))
           OPTIONAL)))
...
(CONCEPT ONT::NYCHTHEMERON-EVENT (INHERIT ONT::EVENT))
...
(CONCEPT ONT::OBJECTIVE-INFLUENCE
         ...
         (SEM-FEATS (INHERIT SITUATION) (TRAJECTORY -))
         (SEM-FRAME (ONT::EFFECT (CONCEPT SITUATION) OPTIONAL)
                    (ONT::RESULT (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::AGENT
                     (OR (CONCEPT SITUATION)
                         (CONCEPT PHYS-OBJ)
                         (CONCEPT ABSTR-OBJ)))
...
(CONCEPT ONT::PATH-SHAPE
         (INHERIT ONT::PHYSICAL-MOTION)
         (SEM-FRAME (ONT::PATH (CONCEPT T))))
...
(CONCEPT ONT::PROMISE
         (INHERIT ONT::COMMUNICATION)
         (OVERLAP WN::|promise%2:32:00| WN::|assure%2:32:02|)
         (SEM-FEATS (INHERIT SITUATION) (CAUSE AGENTIVE))
         (SEM-FRAME
          (ONT::ADDRESSEE
           (SEM-FEATS (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ))
...
(CONCEPT ONT::PROPERTY-VAL
         ...
         (SEM-FEATS (INHERIT ABSTR-OBJ)
                    ...
                    (CONTAINER -))
         (SEM-FRAME
          (ONT::PURPOSE-IMPLICIT
           (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ) (CONCEPT SITUATION))
           OPTIONAL)
          (ONT::AFFECTED
           (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ) (CONCEPT SITUATION))
           OPTIONAL)
          (ONT::PURPOSE (SEM-FEATS (INHERIT SITUATION) (ASPECT DYNAMIC))
           OPTIONAL)
          (ONT::NEUTRAL (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)) OPTIONAL)
          (ONT::NEUTRAL1 (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)) OPTIONAL)
          (ONT::OF (CONCEPT T))))
...
(CONCEPT ONT::PROPOSE-RECOMMEND-SUGGEST (INHERIT ONT::SUGGEST))
...
(CONCEPT ONT::PUBLICATION
         ...
         (SEM-FRAME
          (ONT::ORIGINATOR (SEM-FEATS (INHERIT ?ORG) (INTENTIONAL +)) OPTIONAL)
          (ONT::OF (SEM-FEATS (INHERIT ?O) (INFORMATION INFORMATION-CONTENT))
           OPTIONAL)))
...
(CONCEPT ONT::PURPOSE
         (INHERIT ONT::SITUATION-MODIFIER)
         (SEM-FRAME (ONT::OBJ-VAL (CONCEPT ABSTR-OBJ))
...
(CONCEPT ONT::RELY-DEPEND (INHERIT ONT::POSITION))
...
(CONCEPT ONT::RENDER-INEFFECTIVE
         ...
         (SEM-FRAME (ONT::CAUSE (CONCEPT T) OPTIONAL)
                    (ONT::AFFECTED
                     (OR (CONCEPT SITUATION) (CONCEPT ABSTR-OBJ)))))
...
(CONCEPT ONT::REPLACEMENT
         ...
         (OVERLAP WN::|change%1:06:00|
                  ...
                  WN::|exchange%2:40:02|)
         (SEM-FRAME (ONT::TO-LOC (CONCEPT T) OPTIONAL)
                    (ONT::FROM-LOC (CONCEPT T) OPTIONAL)
                    (ONT::PLACE (CONCEPT T) OPTIONAL)
                    (ONT::AFFECTED1
                     (OR (CONCEPT SITUATION)
                         (CONCEPT ABSTR-OBJ)
                    ...
                    (ONT::AFFECTED
                     (OR (CONCEPT SITUATION)
                         (CONCEPT ABSTR-OBJ)
                         (CONCEPT PHYS-OBJ)))
                    (ONT::CO-AGENT (CONCEPT T) OPTIONAL)
                    (ONT::AGENT (CONCEPT T))))
...
(CONCEPT ONT::REPRESENTATIVE (INHERIT ONT::KIND))
...
(CONCEPT ONT::RESTART
         (INHERIT ONT::START)
         (OVERLAP WN::|restart%2:38:00| WN::|re-start%2:38:00|)
         (SEM-FEATS (INHERIT SITUATION)
                    (TIME-SPAN ATOMIC)
                    (TRAJECTORY -)
                    (CAUSE AGENTIVE)))
...
(CONCEPT ONT::RESUME-ACTION (INHERIT ONT::ACTIVITY-ONGOING))
...
(CONCEPT ONT::RITUAL-CLASSIFICATION
         (INHERIT ONT::CATEGORIZATION)
         (OVERLAP WN::|anoint%2:31:00| WN::|instal%2:41:00|))
...
(CONCEPT ONT::ROUTE
         ...
         (SEM-FEATS (INHERIT PHYS-OBJ)
                    ...
                    (FORM GEOGRAPHICAL-OBJECT)
                    (ORIGIN NON-LIVING))
         (SEM-FRAME (ONT::VIA (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::TO-LOC (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::FROM-LOC (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::OF (CONCEPT PHYS-OBJ) OPTIONAL)))
...
(CONCEPT ONT::SALIENCE
         (INHERIT ONT::EVENT-OF-STATE)
         (SEM-FEATS (INHERIT SITUATION) (TRAJECTORY -) (CAUSE MENTAL))
         (SEM-FRAME (ONT::PLACE (CONCEPT T) OPTIONAL)
                    (ONT::SOURCE (CONCEPT T) OPTIONAL)
                    (ONT::NEUTRAL
                     (SEM-FEATS (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ))
                                (INTENTIONAL +))
...
(CONCEPT ONT::SCHMOOZE-TALK (INHERIT ONT::TALK))
...
(CONCEPT ONT::SEPARATION
         ...
         (OVERLAP WN::|separate%2:35:01|
                  ...
                  WN::|divide%2:42:00|)
         (SEM-FEATS (INHERIT SITUATION) (TRAJECTORY -) (CAUSE AGENTIVE))
         (SEM-FRAME (ONT::INSTRUMENT (CONCEPT T) OPTIONAL)
                    (ONT::CO-RESULT (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::SOURCE (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::AFFECTED1 (CONCEPT PHYS-OBJ) OPTIONAL)
                    (ONT::AFFECTED (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ)))
                    (ONT::AGENT (CONCEPT T) OPTIONAL)))
...
(CONCEPT ONT::SITUATION-ROOT
         ...
         (SEM-FRAME (ONT::SPATIAL-LOC (CONCEPT T) OPTIONAL)
                    ...
                    (ONT::ARG1 (CONCEPT T) OPTIONAL)
                    (ONT::ARG0 (CONCEPT T) OPTIONAL)))
...
(CONCEPT ONT::SPATIAL-LOC
         (INHERIT ONT::PREDICATE)
         (SEM-FRAME (ONT::OF-STATE (CONCEPT ABSTR-OBJ))
                    (ONT::VAL
                     (SEM-FEATS (INHERIT PHYS-OBJ)
                                (FORM (OR OBJECT SOLID LIQUID GAS))))
                    (ONT::OF (OR (CONCEPT PHYS-OBJ) (CONCEPT SITUATION)))))
...
(CONCEPT ONT::SUCCEED
         (INHERIT ONT::ACTING)
         (OVERLAP WN::|hold_one's_own%2:42:00| WN::|succeed%2:41:00|)
         (SEM-FRAME (ONT::AGENT (CONCEPT T) OPTIONAL)
                    (ONT::EFFECT (CONCEPT SITUATION))
                    (ONT::INSTRUMENT
                     (SEM-FEATS (INHERIT PHYS-OBJ) (INTENTIONAL -)) OPTIONAL)))
...
(CONCEPT ONT::SWEAR (INHERIT ONT::STATEMENT))
...
(CONCEPT ONT::TAKE (INHERIT ONT::EXECUTE) (OVERLAP WN::|take%2:41:04|))
...
(CONCEPT ONT::TEACH-TRAIN
         (INHERIT ONT::TRANSFER-INFORMATION)
         (OVERLAP WN::|describe%2:32:00|
                  WN::|depict%2:32:01|
                  WN::|draw%2:32:00|))
...
(CONCEPT ONT::TELL (INHERIT ONT::TALK))
...
(CONCEPT ONT::TIME-CLOCK-REL
         (INHERIT ONT::TEMPORAL-LOCATION)
         (SEM-FRAME (ONT::SIT-VAL (CONCEPT SITUATION))
                    (ONT::VAL
                     (SEM-FEATS (INHERIT TIME)
...
(CONCEPT ONT::TIME-CULMINATION-REL
         ...
         (SEM-FRAME
          (ONT::TIME-VAL
           (SEM-FEATS (INHERIT ABSTR-OBJ) (SCALE TIME-MEASURE-SCALE)) OPTIONAL)
          (ONT::RESULT-VAL (CONCEPT ABSTR-OBJ) OPTIONAL)
          (ONT::VAL (SEM-FEATS (INHERIT ABSTR-OBJ) (SCALE DURATION-SCALE)))
          (ONT::OF
           (SEM-FEATS (INHERIT SITUATION)
                      (TIME-SPAN EXTENDED)
...
(CONCEPT ONT::TIME-POINT
         ...
         (SEM-FRAME (ONT::INTERVAL (CONCEPT TIME) OPTIONAL)
                    (ONT::ACTION
                     (SEM-FEATS (INHERIT SITUATION) (ASPECT UNBOUNDED))
                     OPTIONAL)
                    (ONT::OF (OR (CONCEPT SITUATION) (CONCEPT TIME)) OPTIONAL)))
...
(CONCEPT ONT::TIME-SPAN-REL
         ...
         (SEM-FRAME (ONT::SIT-VAL (CONCEPT SITUATION))
                    (ONT::VAL
                     (SEM-FEATS (INHERIT TIME)
                                (TIME-FUNCTION
                                 (OR MONTH-NAME YEAR-NAME DAY-PERIOD))
                                (TIME-SCALE INTERVAL)))))
...
(CONCEPT ONT::TOUR (INHERIT ONT::EVENT))
...
(CONCEPT ONT::UNLOAD
         ...
         (SEM-FEATS (INHERIT SITUATION)
                    ...
                    (ASPECT DYNAMIC))
         (SEM-FRAME
          (ONT::FROM-LOC (SEM-FEATS (INHERIT PHYS-OBJ) (CONTAINER +)))))
...
(CONCEPT ONT::USE
         ...
         (SEM-FRAME
          ...
          (ONT::PURPOSE (CONCEPT SITUATION) OPTIONAL)
          (ONT::FORMAL1
           (OR (CONCEPT PHYS-OBJ) (CONCEPT ABSTR-OBJ) (CONCEPT SITUATION))
           OPTIONAL)
          (ONT::FORMAL
...
(CONCEPT ONT::VACATION (INHERIT ONT::EVENT))
