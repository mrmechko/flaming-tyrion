    ...
    (ONT::SCALE
     (SEM-FEATS
       (INHERIT
         ABSTR-OBJ)
       (ORIENTATION POS)
       (SCALE ONT::TEXTURE-THINESS-SCALE))
     OPTIONAL)))
